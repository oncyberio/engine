...
import { LineBasicMaterial, Matrix4, LineSegments } from "three";

let defaultOcclusionMaterial = new LineBasicMaterial({ color: 0x000000 });

let defaultMirrorMaterial = new LineBasicMaterial({ color: 0x00ff00 });

let defaultMaterialLight = new LineBasicMaterial({ color: 0x0000ff });

let state = Object.assign({}, DEFAULT_STATE);

export default class PipeLineBasicLine extends LineSegments {
