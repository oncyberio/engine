import { Matrix4, Mesh, MeshBasicMaterial, MeshLambertMaterial } from "three";
...
export default class PipeLineMesh extends Mesh {
  constructor(geometry, material, rule = {}) {
    ...
    this.updateMaterials(material, rule);
