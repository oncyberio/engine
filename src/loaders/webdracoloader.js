...
export class WebDracoLoader extends Loader {
    constructor(manager) {
        super(manager);
        ...
        if(__BUILD_TARGET__ == "web") {
            ...
            if (useJS) {
                librariesPending.push(
                    this._loadLibrary("draco_decoder.js", "text"),
                );
            } else {
                librariesPending.push(
    ...
    _getWorker(taskID, taskCost) {
        return this._initDecoder().then(() => {
            if (this.workerPool.length < this.workerLimit) {
                ...
                // console.log("Creating new worker", this.workerSourceURL)
                ...
                if(__BUILD_TARGET__ == "web") {
                    ...
                    worker = new Worker( new URL("./draco_decoder.js" , import.meta.url));
                }
