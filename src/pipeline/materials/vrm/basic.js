...
import PreVertex from "./shader/pre.vertex.glsl";

import MainVertex from "./shader/main.vertex.glsl";

import SuffVertex from "./shader/suff.vertex.glsl";

import PreFrag from "./shader/pre.frag.glsl";

import MainFrag from "./shader/main.frag.glsl";

import SuffFrag from "./shader/suff.frag.glsl";

export default class VRMBasicMaterial extends InstancedBasic {
  constructor(options) {
    // debugger;
